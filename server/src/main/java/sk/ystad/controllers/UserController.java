...
public class UserController {
    ...
    public AuthResponse register(@RequestParam(value = "password") String password, @RequestParam(value = "surname") String surname,
    ...
    public AuthResponse verify(@PathVariable String token) {
