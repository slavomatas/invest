...
import sk.ystad.model.timeseries.database_objects.date.AbstractDateDoubleTimeSeries;
import sk.ystad.model.timeseries.database_objects.date.DateDoubleTimeSeries;

import java.time.LocalDate;
import java.util.*;

import static sk.ystad.model.timeseries.database_objects.DoubleTimeSeriesOperators.*;
...
abstract class AbstractLocalDateDoubleTimeSeries
    ...
    static Map.Entry<LocalDate, Double> makeMapEntry(LocalDate key, Double value) {
        return new AbstractMap.SimpleImmutableEntry<LocalDate, Double>(key, value);
    }
    ...
    // -------------------------------------------------------------------------
    private LocalDateDoubleTimeSeries operate(DoubleTimeSeries<?> other, DoubleTimeSeriesOperators.BinaryOperator operator) {
    ...
    private LocalDateDoubleTimeSeries operateWithSameTimes(DateDoubleTimeSeries<?> other, DoubleTimeSeriesOperators.BinaryOperator operator) {
    ...
    private LocalDateDoubleTimeSeries unionOperate(DoubleTimeSeries<?> other, DoubleTimeSeriesOperators.BinaryOperator operator) {
        if (other instanceof DateDoubleTimeSeries) {
