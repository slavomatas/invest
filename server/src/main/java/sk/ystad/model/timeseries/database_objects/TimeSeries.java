...
public interface TimeSeries<T, V> extends Iterable<Map.Entry<T, V>> {
     ...
     *
     * @param dateTime the date-time to retrieve, not null
     * @return the value at the date-time, null if date-time not present or if the implementation permits nulls
     */
     ...
     * @throws IndexOutOfBoundsException if the index is invalid, or the size of this series is less than the size
     *                                   requested
     */
