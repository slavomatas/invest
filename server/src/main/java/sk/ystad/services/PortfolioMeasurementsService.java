...
import sk.ystad.model.timeseries.database_objects.TimeSeriesItem;
...
public class PortfolioMeasurementsService {
    ...
    public List<TimeSeriesItem> getMeasurement(@PathVariable("portfolioId") String portfolioId,
        ...
        List<TimeSeriesItem> timeSeriesItems = new ArrayList<>();
        ...
        for (int i = 0; i < timeSeries.size(); i++) {
            ...
            TimeSeriesItem item = new TimeSeriesItem(name.toString(), value.toString());
