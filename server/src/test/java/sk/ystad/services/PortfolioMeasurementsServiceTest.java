...
public class PortfolioMeasurementsServiceTest {
    ...
    public void returnCumulativeMeasurementsForGivenPortfolio() throws Exception {
        ...
        mvc.perform(get("/measurements/cumulative_measurement")
                ...
                .andExpect(jsonPath("$[0].date-time-stamp").value(timeSeries.getTimeAtIndex(0).toString()))
                .andExpect(jsonPath("$[0].value").value(timeSeries.getValueAtIndex(0)))
                .andExpect(jsonPath("$[1].date-time-stamp").value(timeSeries.getTimeAtIndex(1).toString()))
                .andExpect(jsonPath("$[1].value").value(timeSeries.getValueAtIndex(1)))
                .andExpect(jsonPath("$[2].date-time-stamp").value(timeSeries.getTimeAtIndex(2).toString()))
                .andExpect(jsonPath("$[2].value").value(timeSeries.getValueAtIndex(2)))
                .andExpect(jsonPath("$[3].date-time-stamp").value(timeSeries.getTimeAtIndex(3).toString()))
                .andExpect(jsonPath("$[3].value").value(timeSeries.getValueAtIndex(3)))
                .andExpect(jsonPath("$[4].date-time-stamp").value(timeSeries.getTimeAtIndex(4).toString()))
                .andExpect(jsonPath("$[4].value").value(timeSeries.getValueAtIndex(4)))
                .andExpect(jsonPath("$[5].date-time-stamp").value(timeSeries.getTimeAtIndex(5).toString()))
                .andExpect(jsonPath("$[5].value").value(timeSeries.getValueAtIndex(5)))
                .andExpect(jsonPath("$[6].date-time-stamp").value(timeSeries.getTimeAtIndex(6).toString()))
